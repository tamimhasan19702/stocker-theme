    ...
    <div class="row gx-0 align-items-center">
        <div class="col-lg-8 text-center text-lg-start mb-2 mb-lg-0">
            <div class="d-flex flex-wrap">
                <a href="#" class="text-muted small me-4"><i class="fa fa-map-marker text-primary me-2"
                        style="vertical-align:middle"></i>Find A Location</a>
                <a href="tel:+01234567890" class="text-muted small me-4"><i class="fa fa-phone text-primary me-2"
                        style="vertical-align:middle"></i>+01234567890</a>
                <a href="mailto:example@gmail.com" class="text-muted small me-0">
                    <i class="fa fa-envelope text-primary me-2" style="vertical-align:middle"></i>Example@gmail.com</a>
            </div>
        </div>
